...
const pagesToVisit = [
  { name: 'Wykaz_domen', url: '/domains/list' },
...
// Also check the SSH settings - might be useful
await page.goto('https://admin.nazwa.pl/settings/ssh', { waitUntil: 'networkidle' });
await page.waitForTimeout(2000);
await page.screenshot({ path: 'C:\\Users\\Wychowanek.St8\\Downloads\\evolve-project-shine-main\\evolve-project-shine-main\\computer-control\\screenshots\\SSH.png', fullPage: false });
const html = await page.content();
writeFileSync('C:\\Users\\Wychowanek.St8\\Downloads\\evolve-project-shine-main\\evolve-project-shine-main\\computer-control\\screenshots\\SSH.html', html);
console.log(`OK: SSH -> ${page.url()}`);
