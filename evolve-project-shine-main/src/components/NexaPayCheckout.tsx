...
export function NexaPayCheckout({ amount, planName, amountUsd }: Props) {
  ...
  return (
    <button
      onClick={handlePay}
      className="w-full py-3 rounded-xl text-sm font-medium transition bg-gradient-to-br from-cyan-300 via-white to-violet-200 text-black hover:shadow-[0_8px_32px_-8px_rgba(34,211,238,0.6)] inline-flex items-center justify-center gap-2 overflow-hidden group"
    >
